...
readTime: "5 min read"
tag: "Layout"
excerpt: "Return current flows directly under the trace, not wherever it likes. What a slot in the pour really does, and how PCB 2 keeps logic ground and field ground apart."
---
...
## How PCB 2 splits its grounds

PCB 2 is a field I/O controller: 9–36 VDC or 24 VAC in, a buck to 5 V, an AP2112K to 3.3 V, an ESP32-S3, PC817 opto-isolated inputs, and relay and low-side MOSFET outputs.
