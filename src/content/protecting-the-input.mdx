...
On PCB 2 the 24V front end runs, from the screw terminal inward: PPTC, bridge rectifier, TVS, bulk electrolytic, buck.
...
If the input might be AC as well as DC, neither of those is the answer: use a full bridge rectifier. That is what PCB 2 does, because its terminal takes 9–36 VDC or 24 VAC and an installer should not have to care which way round two field wires go. It costs two forward drops instead of one — roughly 1.8V, so 9V in still leaves about 7.2V for a 5V buck — and reverse-wired DC stops being something you protect against and becomes impossible.
